<template>
  ...
  <transition appear name="v-img-fade">
    <div v-if="!closed" class="fullscreen-v-img" @click.self="close">
      ...
      <!-- Controls start -->
      <transition appear name="v-img-fade">
        <span v-if="visibleUI && images.length !== 1" class="prev-v-img remove-arrows-mob" @click="prev">
      ...
      <transition appear name="v-img-fade">
        <span v-if="visibleUI && images.length !== 1" class="next-v-img remove-arrows-mob" @click="next">
          <svg width="25" height="25" viewBox="0 0 1792 1915" xmlns="http://www.w3.org/2000/svg">
